...
if __name__ == "__main__":
    ...
    for speaker in tqdm(os.listdir(args.source_dir)):
        ...
        for file in wavs:
            ...
            if not pattern.match(file):
                print(f"warning: Non-alphanumeric underscores in the filename {file} may cause an error. (or maybe not)")
    ...
    create_file_path(args.train_list)
    ...
    create_file_path(args.val_list)
    ...
    create_file_path("configs/config.json")
